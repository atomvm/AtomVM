...
%% {@link set_format/4}, {@link transmit/3}, {@link receive_/3},
...
-export_type([spi/0, spi_resource/0, device_name/0, address/0, transaction/0, spi_state/0]).
...
%%
%%          Reinitializes the SPI peripheral with the closest achievable
%%          prescaler divider.
%% @end
%%-----------------------------------------------------------------------------
...
%%-----------------------------------------------------------------------------
%% @param   Resource SPI resource returned by `init/2'
%% @param   DataBits Number of data bits per transfer (8 or 16)
...
%% @end
%%-----------------------------------------------------------------------------
-spec set_format(Resource :: spi_resource(), DataBits :: 8 | 16, CPOL :: 0 | 1, CPHA :: 0 | 1) ->
    ok.
