...
%%              <li>`{clock_speed_hz, Hz}' - bus clock speed (default: 1000000)</li>
...
open(Params) ->
    ...
    ClockSpeedHz = get_value(clock_speed_hz, BusConfig, ?DEFAULT_CLOCK_SPEED_HZ),
    maybe_set_af(SCLK, AF),
    maybe_set_af(MOSI, AF),
    maybe_set_af(MISO, AF),
    Config = #{baudrate => ClockSpeedHz},
