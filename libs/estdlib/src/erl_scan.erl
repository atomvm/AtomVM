...
%%--------------------------------------------------------------------------
%% @doc Uses an `ErrorDescriptor` and returns a string that describes the error or
%%      warning.
%%
%%      This function is usually called implicitly when an `ErrorInfo` structure
%%      is processed (see section [Error Information](`m:erl_scan#module-error-information`)).
%%
%% @end
%%--------------------------------------------------------------------------
...
%%--------------------------------------------------------------------------
%% @doc Takes the list of characters `String` and tries to scan (tokenize) them.
%%     
...
%%--------------------------------------------------------------------------
%% @doc This is the re-entrant scanner, which scans characters until either a _dot_ ('.'
...
%%--------------------------------------------------------------------------
%% @since OTP 18.0
%% @doc   Returns the end location of the text of `Token`'s collection of annotations. If
...
%%--------------------------------------------------------------------------
%% @since OTP 18.0
%% @doc   Returns the text of `Token`'s collection of annotations. If there is no text,
