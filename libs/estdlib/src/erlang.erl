...
%% <ul>
%%      <li><b>avm_free_heap_size</b> the number of (noncontiguous) free bytes in the STM32 heap (integer)</li>
%%      <li><b>avm_minimum_free_size</b> the smallest number of free bytes in the STM32 heap since boot (integer)</li>
%% </ul>
%%
