...
-define(PRIM_TERM_MAYBE_UNBOX_INT64, 58).
-define(PRIM_BITSTRING_COPY_MODULE_STR, 59).
-define(PRIM_BITSTRING_COPY_BINARY, 60).
-define(PRIM_APPLY, 61).
-define(PRIM_MALLOC, 62).
-define(PRIM_FREE, 63).
-define(PRIM_PUT_MAP_ASSOC, 64).
-define(PRIM_BITSTRING_EXTRACT_FLOAT, 65).
-define(PRIM_MODULE_GET_FUN_ARITY, 66).
-define(PRIM_BITSTRING_MATCH_MODULE_STR, 67).
-define(PRIM_BITSTRING_GET_UTF8, 68).
-define(PRIM_BITSTRING_GET_UTF16, 69).
-define(PRIM_BITSTRING_GET_UTF32, 70).
-define(PRIM_TERM_COPY_MAP, 71).
-define(PRIM_STACKTRACE_BUILD, 72).
