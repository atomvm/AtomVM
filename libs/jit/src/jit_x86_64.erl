...
call_func_ptr(
    ...
    {
        State1#state{stream = Stream5, available_regs = AvailableRegs3, available_fpregs = AvailableFP3, used_regs = UsedRegs2},
        ResultReg
    }.
