...
dwarf_opcode(#state{stream = Stream0, regs = Regs} = State, OpCode) ->
    XRegMap = jit_dwarf:extract_x_reg_locations(Regs, fun dwarf_register_number/1),
    Stream1 = jit_dwarf:opcode(Stream0, OpCode, XRegMap),
