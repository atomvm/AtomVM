...
-define(FUNCTION_CLAUSE_ATOM, ((?FUNCTION_CLAUSE_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(TRY_CLAUSE_ATOM, ((?TRY_CLAUSE_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(OUT_OF_MEMORY_ATOM, ((?OUT_OF_MEMORY_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(BADMATCH_ATOM, ((?BADMATCH_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(CASE_CLAUSE_ATOM, ((?CASE_CLAUSE_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
...
-define(UNSUPPORTED_ATOM, ((?UNSUPPORTED_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(ALL_ATOM, ((?ALL_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
-define(LOWERCASE_EXIT_ATOM, ((?LOWERCASE_EXIT_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
