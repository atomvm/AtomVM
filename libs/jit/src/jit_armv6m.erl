...
%% ARMv6-M has no FPU, so no FP registers
-define(IS_FPR(_Reg), false).
...
-record(state, {
    ...
    available_fpregs :: [armv6m_register()],
...
-define(AVAILABLE_FPREGS, []).
-define(PARAMETER_REGS, [r0, r1, r2, r3]).
%% ARMv6-M has no FPU
-define(PARAMETER_FPREGS, []).
...
move_to_vm_register(
    ...
    I2 = jit_armv6m_asm:str(Reg, {Temp, F * 4}),
...
move_to_native_register(
    ...
    I1 = jit_armv6m_asm:ldr(Temp, ?FP_REGS),
    I2 = jit_armv6m_asm:ldr_d(FPReg, {Temp, F * 4}),
    Code = <<I1/binary, I2/binary>>,
    Stream1 = StreamModule:append(Stream0, Code),
...
move_to_native_register(
    ...
    I1 = jit_armv6m_asm:ldr(Temp, ?FP_REGS),
    I2 = jit_armv6m_asm:ldr_d(RegDst, {Temp, F * 4}),
    Code = <<I1/binary, I2/binary>>,
    Stream1 = StreamModule:append(Stream0, Code),
    State#state{stream = Stream1}.
