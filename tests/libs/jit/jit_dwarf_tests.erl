...
elf_with_text_test() ->
    ...
    case jit_dwarf:elf(State, NativeCode) of
        ...
        {ok, _TextSectionOffset, CombinedELF} ->
            ...
            % Should have 11 sections total (null + .text + 5 debug + .debug_loc + .symtab + .strtab + .shstrtab)
            ?assertEqual(11, SHNum),
...
different_architectures_test() ->
    ...
    Backends = [jit_x86_64, jit_aarch64, jit_armv6m, jit_riscv32],
