...
struct Test tests[] =
{
    ...
    //TEST FAILS HERE: {"nested_list_size2.beam", 8},
    //TEST FAILS HERE: {"nested_list_size3.beam", 68},

    {"simple_list_size0.beam", 2},
    {"simple_list_size1.beam", 10},

    //TEST FAILS HERE: {"tuple_size0.beam", 1},
    {"tuple_size1.beam", 2},
    {"tuple_size2.beam", 3},
    {"tuple_size3.beam", 4},
    {"tuple_size4.beam", 13},
    //TEST CRASHES HERE: {"tuple_size5.beam", 7},
    //TEST FAILS HERE: {"tuple_size6.beam", 17},

    //TEST FAILS HERE: {"tuples_and_list_size0.beam", 3},
    //TEST FAILS HERE: {"tuples_and_list_size1.beam", 5},
    //TEST FAILS HERE: {"tuples_and_list_size2.beam", 10},

    //TEST FAILS HERE: {"nested_tuple_size0.beam", 12},
    ...
    //TEST FAILS HERE: {"complex_struct_size0.beam", 43},
