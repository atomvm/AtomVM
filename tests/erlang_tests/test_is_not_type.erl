...
eval(A, B, C, D, E, F) ->
    bool_to_integer(is_atom(A), 1) + bool_to_integer(is_binary(B), 2) + bool_to_integer(is_integer(C), 4)
    + bool_to_integer(is_list(D), 8) + bool_to_integer(is_reference(E), 16) + bool_to_integer(is_tuple(F), 32)
