...
parse_bigint() ->
    ...
    Pattern10BinCanonical =
        <<"-54826124455256601513636909251356536763516497895406989033472580562929119750424">>,
    Pattern10Int = ?MODULE:id(binary_to_integer(?MODULE:id(Pattern10Bin), 16)),
    Pattern10BinCanonical = ?MODULE:id(integer_to_binary(?MODULE:id(Pattern10Int), 16)),
