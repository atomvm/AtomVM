...
* Linux, macOS, FreeBSD, DragonFly ([generic_unix](https://atomvm.org/doc/main/getting-started-guide.html#getting-started-on-the-generic-unix-platform))
* ESP32 SoC (with IDF/FreeRTOS, see [esp32](https://atomvm.org/doc/main/getting-started-guide.html#getting-started-on-the-esp32-platform))
* STM32 MCUs (with LibOpenCM3, see [stm32](https://atomvm.org/doc/main/getting-started-guide.html#getting-started-on-the-stm32-platform))
* Raspberry Pi Pico (see [rp2040](https://atomvm.org/doc/main/getting-started-guide.html#getting-started-on-the-raspberry-pi-pico-platform))
* Browsers and NodeJS with WebAssembly (see [emscripten](https://atomvm.org/doc/main/getting-started-guide.html#getting-started-with-atomvm-webassembly))
...
["Getting Started Guide"](https://atomvm.org/doc/main/getting-started-guide.html),
[examples](https://atomvm.org/sample-code),
detailed [build instructions](https://atomvm.org/doc/main/build-instructions.html),
...
Complete [Build Instructions](https://atomvm.org/doc/main/build-instructions.html) are
available in the documentation for
[Generic UNIX](https://atomvm.org/doc/main/build-instructions.html) (Linux, MacOS, FreeBSD, DragonFly),
[ESP32](https://atomvm.org/doc/main/build-instructions.html#building-for-esp32),
[STM32](https://atomvm.org/doc/main/build-instructions.html#building-for-stm32),
[Raspberry Pi Pico](https://atomvm.org/doc/main/build-instructions.html#building-for-raspberry-pi-pico)
(rp2040), and
[WASM](https://atomvm.org/doc/main/build-instructions.html#building-for-nodejs-web) (NodeJS/Web).
