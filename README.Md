...
A short but explanatory introduction into the usage of the VM can be found in this [blog post](https://medium.com/@Bettio/atomvm-how-to-run-elixir-code-on-a-3-microcontroller-b414773498a6)
