...
macro(pack_runnable avm_name main)
    ...
    foreach(archive_name ${PACK_RUNNABLE_UNPARSED_ARGUMENTS})
        if(NOT ${archive_name} STREQUAL "exavmlib")
            ...
            if(NOT ${archive_name} MATCHES "^(eavmlib|estdlib|alisp|avm_network|avm_esp32|avm_rp2|avm_stm32|avm_zephyr|avm_emscripten)$")
        ...
        elseif(${archive_name} STREQUAL "avm_zephyr")
            set(pack_runnable_${avm_name}_plt_name "atomvmlib-zephyr")
    ...
    if(PACK_RUNNABLE_DIALYZE_AGAINST)
        ...
        foreach(plt_lib IN LISTS PACK_RUNNABLE_DIALYZE_AGAINST)
            ...
            elseif(${plt_lib} STREQUAL "avm_zephyr")
                list(APPEND pack_runnable_${avm_name}_plt_names "atomvmlib-zephyr")
