...
#define MIN_FREE_SPACE_ATOM_INDEX 60
#define SHRINK_FREE_SPACE_FACTOR_ATOM_INDEX 61
#define AVAILABLE_FREE_MEMORY_ATOM_INDEX 62
#define NUM_GCS_ATOM_INDEX 63
#define NUM_GC_SHRINKS_ATOM_INDEX 64
...
#define MIN_FREE_SPACE_ATOM TERM_FROM_ATOM_INDEX(MIN_FREE_SPACE_ATOM_INDEX)
#define SHRINK_FREE_SPACE_FACTOR_ATOM TERM_FROM_ATOM_INDEX(SHRINK_FREE_SPACE_FACTOR_ATOM_INDEX)
#define AVAILABLE_FREE_MEMORY_ATOM TERM_FROM_ATOM_INDEX(AVAILABLE_FREE_MEMORY_ATOM_INDEX)
#define NUM_GCS_ATOM TERM_FROM_ATOM_INDEX(NUM_GCS_ATOM_INDEX)
#define NUM_GC_SHRINKS_ATOM TERM_FROM_ATOM_INDEX(NUM_GC_SHRINKS_ATOM_INDEX)
