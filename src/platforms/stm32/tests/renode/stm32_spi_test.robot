...
AtomVM Should Communicate Over SPI
    ...
    Execute Command    machine LoadPlatformDescriptionFromString "spiFlashMemory: Memory.MappedMemory { size: 0x100000 }; spiFlash: SPI.Micron_MT25Q @ spi1 { underlyingMemory: spiFlashMemory }"
