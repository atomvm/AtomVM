...
#define ACTIVE_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 12)
#define BUFFER_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 13)
#define CONNECT_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 14)
#define SEND_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 15)
#define TCP_CLOSED_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 16)
#define RECV_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 17)
#define LISTEN_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 18)
#define BACKLOG_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 19)
#define ACCEPT_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 20)
#define FD_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 21)

#define INIT_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 22)
#define CLOSE_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 23)
#define GET_PORT_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 24)
#define SOCKNAME_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 25)
#define PEERNAME_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 26)
#define NOT_OWNER_ATOM_INDEX (SOCKET_ATOMS_BASE_INDEX + 27)

#define SPIDRIVER_ATOMS_BASE_INDEX (SOCKET_ATOMS_BASE_INDEX + 28)
