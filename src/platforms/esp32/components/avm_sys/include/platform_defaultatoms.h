...
#define SPEED_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 0)
#define WRITE_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 1)
#define DATA_BITS_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 2)
#define STOP_BITS_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 3)
#define FLOW_CONTROL_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 4)
#define PARITY_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 5)
#define TX_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 6)
#define RX_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 7)
#define RTS_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 8)
#define CTS_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 9)
#define DEFAULT_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 10)
#define EVENT_QUEUE_LEN_ATOM_INDEX (UART_ATOMS_BASE_INDEX + 11)
