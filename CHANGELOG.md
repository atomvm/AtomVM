...
- Improved SMP scheduler performance; resources stopped with `ERL_NIF_SELECT_STOP_SCHEDULED` are
  now released asynchronously by the polling scheduler, as the `enif_select` specification allows
