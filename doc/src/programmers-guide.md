...
Note that the [`io_lib`](./apidocs/erlang/estdlib/io_lib.md) module can be used to format string data, as well.
...
On ESP32, you can perform symmetric encryption and decryption of any iodata data using
[`crypto_one_time/4,5`](./apidocs/erlang/estdlib/crypto.md#function-index) function.
